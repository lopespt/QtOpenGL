...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DateTime_t, stringdata) + ofs \
...
void DateTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DateTime::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DateTime::changed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DateTime::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DateTime.data,
      qt_meta_data_DateTime,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DateTime.stringdata))
...
// SIGNAL 0
void DateTime::changed(QString _t1)
{
